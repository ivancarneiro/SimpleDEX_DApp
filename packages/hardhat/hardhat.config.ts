...
// My ALCHEY API key
const providerApiKey = process.env.ALCHEMY_API_KEY || "_NnxKsydv4jOS2HXAMn2g6YcMvztToxc";
// If not set, it uses the hardhat account 0 private key.
// You can generate a random account with `yarn generate` or `yarn account:import` to import your existing PK
const deployerPrivateKey =
  // process.env.__RUNTIME_DEPLOYER_PRIVATE_KEY ?? "0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80";
  // My deployerPrivateKey
  process.env.__RUNTIME_DEPLOYER_PRIVATE_KEY ?? "7a27fa2d62ee9c9cd1551bf769b045f6196dcf250d3065354bd980460f2ac38e";
